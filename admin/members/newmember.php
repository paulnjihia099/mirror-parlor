...
<?php include(ROOT_PATH . '/app/helpers/adminheader.php') ?>  
   ...
   <div class="wrapper">  
        ...
        <div class="mainbar">
            <h3 class="text-center pb-3">Add Members</h3>
            ...
            <form action='newmember.php' method='post' class="container rounded ">
                <!-- errors -->
               ...
               <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name='confPassword' value='<?php echo $confPassword ?>' class="shadow p-2 mb-5 bg-light rounded border-0 form-control" placeholder='Confirm password'>
                </div>
                ...
                <?php endif; ?>
                <div class="mb-5 ">
                    <button type='submit' name='btnAdd' class=" hop text-center p-2 float-right rounded border-0 btn bg-primary">Add</button>
                </div>
            </form>
        </div>
    </div>

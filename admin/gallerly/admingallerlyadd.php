...
<?php include(ROOT_PATH . '/app/helpers/adminheader.php') ?>
   ...
   <?php include(ROOT_PATH . '/app/helpers/adminsidebar.php') ?>
        ...
        <div class="mainbar">
            <h3 class="text-center pb-3">Add Images</h3>
            ...
            <button class="btn btn-primary mt-3 mb-5" ><a href="index.php" class="text-white">Manage</a>  </button>
              ...
              <div class="container col-sm-12">
                <form action="admingallerlyadd.php" method="post" enctype="multipart/form-data" class="mb-5">
                    <!-- errors -->
                ...
                <div style="height: 200px; width: 200px;" class="rounded"> 
